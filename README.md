...
[docs/getting-started.md](docs/getting-started.md). For how the signing/verification internals
and DI wiring actually work, see [docs/architecture.md](docs/architecture.md).
